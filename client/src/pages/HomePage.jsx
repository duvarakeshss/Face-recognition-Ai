...
function Homepage() {
  return (
    <div className="py-8">
      {/* Hero Section */}
      <div className="text-center py-12 px-4 bg-white rounded-lg shadow-md mb-8">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md mb-12">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Recognize</h3>
            <p className="text-gray-600 text-center">
      ...
      {/* CTA Section */}
      <div className="bg-blue-600 text-white p-8 rounded-lg shadow-md text-center">
